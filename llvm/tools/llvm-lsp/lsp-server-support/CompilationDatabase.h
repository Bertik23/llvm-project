...
#ifndef LLVM_TOOLS_LLVMLSP_LSPSERVERSUPPORT_COMPILATIONDATABASE_H
#define LLVM_TOOLS_LLVMLSP_LSPSERVERSUPPORT_COMPILATIONDATABASE_H
...
#endif // LLVM_TOOLS_LLVMLSP_LSPSERVERSUPPORT_COMPILATIONDATABASE_H
