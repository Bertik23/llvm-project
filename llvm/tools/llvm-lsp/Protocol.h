...
struct GetIRBeforePassParams {
  ...
  unsigned passnumber;
  /// Additional arguments passed to opt for this and all descendant files.
  std::optional<std::vector<std::string>> pipeline_opt_args;
  /// Additional arguments passed to opt for this file only.
  std::optional<std::vector<std::string>> pass_opt_args;
};
...
struct RunPassOnIRParams {
  ...
  /// Additional arguments passed to opt for this file only.
  std::optional<std::vector<std::string>> pass_opt_args;
  /// Optional stderr output path
  std::optional<std::string> stderr_path;
};

bool fromJSON(const llvm::json::Value &Value, RunPassOnIRParams &Result,
              llvm::json::Path Path);
